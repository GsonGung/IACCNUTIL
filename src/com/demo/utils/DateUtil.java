 ...
 * 
 * @author  AndyGong
 * @version  [YOUFULI V300R001C01, 2017年10月10日 下午1:10:54]
 * @see  [相关类/方法]
 * @since  [产品/模块版本]
 */
...
public class DateUtil
{
     ...
     * @see [类、类#方法、类#成员]
     */
    public static String getSubTwoTimeYY(String startTime, String endTime)
    {
        ...
        try
        {
            ...
            long diff = et.getTime() - st.getTime();// 这样得到的差值是微秒级别
            long days = diff / (1000 * 60 * 60 * 24);
            return "" + days;
        }
        catch (Exception e)
    ...
    public static List getShortYMDList(String startShortYMD, String endShortYMD)
        throws ParseException
    {
     ...
     */
    @SuppressWarnings({"rawtypes", "unchecked"})
    public static List getShortYMList(String startShortYM, String endShortYM)
        throws ParseException
    {
     ...
     * @throws Exception
     */
    public static int compareEndAndStart(String start, String end)
        throws Exception
    {
        long s = 0;
        if (8 == start.length())
    ...
    public static Date addDate1(Date d, long day)
        throws ParseException
    {
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println(getSubTwoTimeYY("2016-04-14", "2016-04-14"));
        System.out.println(Integer.valueOf(getSubTwoTimeYY("2016-04-15", "2016-04-14"))<=0);
    }

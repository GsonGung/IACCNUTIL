/*
 * 文 件 名:  WaterFeeService.java
 * 版    权:  YOU-FULI (SHANGHAI), INC.
 * 描    述:  <描述>
 * 修 改 人:  AndyGong
 * 修改时间:  2017年10月19日 上午11:41:51
 * 跟踪单号:  <跟踪单号>
 * 修改单号:  <修改单号>
 * 修改内容:  <修改内容>
 */
 ...
 * 
 * @author  AndyGong
 * @version  [YOUFULI V300R001C01, 2017年10月19日 上午11:41:51]
 * @see  [相关类/方法]
 * @since  [产品/模块版本]
 */
public interface WaterFeeService
{
    ...
    Object tradeWaterFee(String customNo, String companyName, String accountNumber);

...
<div dir="ltr" mozdisallowselectionprint moznomarginboxes>
    ...
    <link rel="stylesheet" href="<%=plugins%>pdfjs/web/viewer.css">
    <link rel="resource" type="application/l10n" href="<%=plugins%>pdfjs/web/locale/locale.properties">


    <div tabindex="1" class="loadingInProgress -pdf-body">
        <div id="outerContainer">
            ...
            <div id="sidebarContainer">
                ...
                <div id="sidebarContent">
                    <div id="thumbnailView" style="width: 100%;">
                    </div>
            ...
            <div id="mainContainer">
                ...
                <div id="secondaryToolbar" class="secondaryToolbar hidden doorHangerRight">
                    <div id="secondaryToolbarButtonContainer">
                        ...
                        <a href="javascript:void(0)" id="secondaryViewBookmark" class="secondaryToolbarButton bookmark visibleSmallView"
                    ...
                    <div id="toolbarContainer">
                        <div id="toolbarViewer">
                            ...
                            <div id="toolbarViewerRight">
                                ...
                                <a href="javascript:void(0)" id="viewBookmark" class="toolbarButton bookmark hiddenSmallView"
        ...
        <script src="<%=plugins%>pdfjs/web/compatibility.js"></script>
        <script src="<%=plugins%>pdfjs/web/l10n.js"></script>
        <script src="<%=plugins%>pdfjs/build/pdf.js"></script>
        <script src="<%=plugins%>pdfjs/web/viewer.js"></script>
        <script>
            $(document).ready(function () {
                $('#outerContainer').height(
                    $('.content-wrapper').height() - $('.main-header').height() - $('.page-tabs').height());
            });
        </script>
    </div>
</div>

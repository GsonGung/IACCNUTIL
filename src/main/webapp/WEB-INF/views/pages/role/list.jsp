...
<head>
  ...
  <!-- DataTables -->
  <link rel="stylesheet" href="<%=commonPath%>bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css">
  <!-- Theme style -->
...
<!-- DataTables -->
<script src="<%=commonPath%>bower_components/datatables.net/js/jquery.dataTables.min.js"></script>
<script src="<%=commonPath%>bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js"></script>
<!-- SlimScroll -->

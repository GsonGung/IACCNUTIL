...
<head>
  ...
  <!-- fullCalendar -->
  <link rel="stylesheet" href="<%=commonPath%>bower_components/fullcalendar/dist/fullcalendar.min.css">
  <link rel="stylesheet" href="<%=commonPath%>bower_components/fullcalendar/dist/fullcalendar.print.min.css" media="print">
  <!-- Theme style -->
...
<!-- fullCalendar -->
<script src="<%=commonPath%>bower_components/moment/moment.js"></script>
<script src="<%=commonPath%>bower_components/fullcalendar/dist/fullcalendar.min.js"></script>

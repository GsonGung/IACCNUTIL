            ...
            <ul class="timeline">
                ...
                <li>
                    ...
                    <div class="timeline-item">
                        ...
                        <h3 class="timeline-header no-border"><a href="javascript:void(0)">Sarah Young</a> accepted your friend request</h3>
                    </div>
                </li>
                <!-- END timeline item -->
                <!-- timeline item -->
                ...
                <li>
                    ...
                    <div class="timeline-item">
                        ...
                        <h3 class="timeline-header"><a href="javascript:void(0)">Mr. Doe</a> shared a video</h3>
                        ...
                        <div class="timeline-footer">
                            <a href="javascript:void(0)" class="btn btn-xs bg-maroon">See comments</a>
                        </div>
                    </div>
                </li>
                <!-- END timeline item -->
...
&lt;ul class="timeline">
    ...
    &lt;li>
        ...
        &lt;div class="timeline-item">
            ...
            &lt;h3 class="timeline-header">&lt;a href="javascript:void(0)">Support Team&lt;/a> ...&lt;/h3>

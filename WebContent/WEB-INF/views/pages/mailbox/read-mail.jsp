          ...
          <div class="box box-primary">
            ...
            <div class="box-footer">
              <ul class="mailbox-attachments clearfix">
                ...
                <li>
                  <span class="mailbox-attachment-icon has-img"><img src="<%=commonPath%>dist/img/photo1.png" alt="Attachment"></span>
                ...
                <li>
                  <span class="mailbox-attachment-icon has-img"><img src="<%=commonPath%>dist/img/photo2.png" alt="Attachment"></span>

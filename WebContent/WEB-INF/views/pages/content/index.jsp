...
<body>
	<div id="areascontent">
		...
		<div class="rows" style="overflow: hidden;">
			...
			<div style="float: right; width: 30%;">
				<img src="<%=resourcePath%>img/head01.png" class="img-rounded">
				<img src="<%=resourcePath%>img/head02.png" class="img-circle">
				<img src="<%=resourcePath%>img/head03.png" class="img-thumbnail">
			</div>
		</div>
	</div>
<style>

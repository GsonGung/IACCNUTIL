    ...
    <section class="invoice">
      ...
      <div class="row">
        ...
        <div class="col-xs-6">
          ...
          <img src="<%=commonPath%>dist/img/credit/visa.png" alt="Visa">
          <img src="<%=commonPath%>dist/img/credit/mastercard.png" alt="Mastercard">
          <img src="<%=commonPath%>dist/img/credit/american-express.png" alt="American Express">
          <img src="<%=commonPath%>dist/img/credit/paypal2.png" alt="Paypal">
